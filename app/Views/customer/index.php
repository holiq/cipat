                    ...
                    <?php foreach ($data as $customer) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= route_to('Customer::edit', $customer['id']); ?>" class="btn-link">Edit</a>
                                <a href="<?= route_to('Customer::destroy', $customer['id']); ?>" class="btn-link text-danger" onclick="destroy(event)">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
